 ...
 * 
 * <p>
 * This class represents a Thread of a board, e.g. a 'Moodle board'.
 * </p>
 * 
...
public class BoardThread extends AUserContribution {
    ...
    /**
     * Add a posting to the board thread. The Posting will be sorted immediatly.
     * 
     * @param p
     */
    ...
    /**
     * Get a sorted list of {@link Posting}. {@link Posting} are sorted by the
     * creation date.
     * 
     * @return
     */
    ...
    public String exportToTxt() {
        ...
        txtExport
                .append("FIRST_POSTING_ID: " + this.getFirstPostingId() + "\n");
    ...
    /**
     * Check whether this thread has at least one {@link Posting} instance.
     * 
     * @return
     */
    public boolean hasPostings() {
        return this.postings != null && this.postings.size() > 0;
    }
