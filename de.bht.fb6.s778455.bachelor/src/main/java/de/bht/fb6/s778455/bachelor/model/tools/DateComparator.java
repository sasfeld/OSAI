...
/**
 * <p>
 * This is a date comparator for all {@link AUserContribution}.
 * </p>
 * 
...
public class DateComparator implements Comparator<AUserContribution> {
    ...
    public int compare(AUserContribution o1, AUserContribution o2) {
        if (null == o1.getCreationDate() || null == o2.getCreationDate()) {
            // compare modification date
            if (null == o1.getModificationDate()
                    || null == o2.getModificationDate()) {
                // fallback: if the contribution is a thread, try to get the
                // dates from the posting
                if (o1 instanceof BoardThread && o2 instanceof BoardThread) {
                    BoardThread b1 = (BoardThread) o1;
                    BoardThread b2 = (BoardThread) o2;

                    if (b1.hasPostings() && b2.hasPostings() ) {
                        Posting p1 = b1.getPostings().get(0);
                        Posting p2 = b2.getPostings().get(0);
                        
                     // try modification date first
                        if (p1.getModificationDate() != null
                                && p2.getModificationDate() != null
                                && (p1.getModificationDate().getTime() < p2
                        ...
                        if (p1.getCreationDate() != null
                                && p2.getCreationDate() != null
                                && (p1.getCreationDate().getTime() < p2
                    ...
                    // the thread doesn't have postings or both creation and modification dates are equal
                    return 0;
                }

                return 0; // no comparison possible
            } else {
                if (o1.getModificationDate().getTime() < o2
                        .getModificationDate().getTime()) {
                    return -1;
                }
                if (o1.getModificationDate().getTime() > o2
