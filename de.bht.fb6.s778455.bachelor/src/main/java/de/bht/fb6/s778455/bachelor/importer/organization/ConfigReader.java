...
public class ConfigReader extends APropertiesConfigReader implements
     ...
     */
    public static final String PATH_IMPORT_PROPERTIES = PATH_CONFIG
            + "importer.properties";
    /**
     * Lazy value.
     */
    ...
    public String getAuditoriumHost() {
        return super
                .fetchValue(IConfigKeys.IMPORT_STRATEGY_AUDITORIUM_DB_HOST);
    }

    public String getAuditoriumUser() {
        return super
                .fetchValue(IConfigKeys.IMPORT_STRATEGY_AUDITORIUM_DB_USER);
    }

    public String getAuditoriumPw() {
        return super
                .fetchValue(IConfigKeys.IMPORT_STRATEGY_AUDITORIUM_DB_PW);
    }

    public String getAuditoriumDbName() {
        return super
                .fetchValue(IConfigKeys.IMPORT_STRATEGY_AUDITORIUM_DB_DBNAME);
    }
