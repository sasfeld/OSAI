...
/**
 * <p>This class contains UnitTests of the {@link AnonymizationController}.</p>
 *
...
public class AnonymizationControllerTest {
	...
	public void testPerformAnonymization() throws GeneralLoggingException {
		 Map<String, Board> anonymizedCourses = this.anonymizationController.performAnonymization();
		 assertTrue( null != anonymizedCourses );
		 
		 // some sysouts		
		 for( String course : anonymizedCourses.keySet() ) {
			System.out.println( "##########################");
			System.out.println( "#");
			System.out.println( "# course: " + course);
			Board courseBoard = anonymizedCourses.get( course );
