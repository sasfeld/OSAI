...
/**
 * This is a helper class that provides String filters. It fits the JDOM XPath
 * selections.
 * 
...
public class XmlParserHelper {
	...
	/**
	 * Build an array - this methods should be called when using the XPath
	 * selectNodes() - method.
	 * 
	 * @param modsPersonal
	 *            - the return value of XPath.
	 ...
	 * @throws IllegalArgumentException
	 *             if the input string is empty or null or equals [] (an empty
	 *             mods tag).
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             if the input array of string is empty or null.
	 */
	public static String[] removeCtrlChars( final String[] input ) {
	...
	/**
	 * Remove the characters caused by Saxon. This is necessary if you parse an
	 * attribute because XPath then returns the name of the attribute.
	 * 
	 * @param input
	 *            - the return value of Saxon.
	 ...
	 * 
	 * @param input
	 *            - the return value [an array of String] of Saxon.
	 * @return the cleaned String.
	 */
	public static String[] removeAttributeChars( final String[] input ) {
		if( input == null ) {
