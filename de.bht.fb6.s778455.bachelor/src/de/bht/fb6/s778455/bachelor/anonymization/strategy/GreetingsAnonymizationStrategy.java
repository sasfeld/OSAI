 ...
 * 
 * <p>
 * An example in German would be: "Gru�, Max Mustermann" or "Gru� MM"
 * </p>
 * 
...
public class GreetingsAnonymizationStrategy extends AAnomyzationStrategy {
	...
	/**
	 * Remove a special greeting formula, such as: "Gru�[,] XY", "Gr��le[,] XY",
	 * "Viel Erfolg[,] XY"
	 * 
	 * @param textString
	 ...
	 *            removed
	 * @param greetingWord
	 *            the greeting word which shall be looked up (e.g: "Gru�")
	 * @return
	 * @throws GeneralLoggingException
	 */
