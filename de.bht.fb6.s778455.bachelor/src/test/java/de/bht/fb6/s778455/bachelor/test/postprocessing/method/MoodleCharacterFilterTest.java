 ...
 *
 */
public class MoodleCharacterFilterTest extends NoLoggingTest
{
    ...
    {
        this.method = new MoodleCharacterFilter();
    }
    ...
    {
        String inputText = "<p id=\"yui_3_7_3_3_1386692797241_174\">test</p>";
        String expectedCleanedText = "test";
