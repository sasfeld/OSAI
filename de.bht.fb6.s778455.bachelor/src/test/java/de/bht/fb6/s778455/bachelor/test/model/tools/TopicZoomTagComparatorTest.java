...
public class TopicZoomTagComparatorTest extends NoLoggingTest {
	...
	public TopicZoomTagComparatorTest(TopicZoomTag inputLeftTag, TopicZoomTag inputRightTag, int expectedValue) {
	...
	public static Collection< Object[] > data() {
		...
		Object[] firstRow = new Object [] { new TopicZoomTag(1, 0, 1, "leftTag", "test.tld"),
								new TopicZoomTag( 6, 0, 2, "rightTag", "test.tld" ),
								-1} ;
		// second row: weight of the left is lower, significance is equal
		Object[] secondRow = new Object [] { new TopicZoomTag(1, 0, 1, "leftTag", "test.tld"),
				new TopicZoomTag( 1, 0, 2, "rightTag", "test.tld" ),
				-1} ;
		// third row: weight of the left is lower, signifcance higher
		Object[] thirdRow = new Object [] { new TopicZoomTag(6, 0, 1, "leftTag", "test.tld"),
				new TopicZoomTag( 2, 0, 2, "rightTag", "test.tld" ),
				0} ;
		// fourth row: weight of the left is equal, significance is lower
		Object[] fourthRow = new Object [] { new TopicZoomTag(2, 0, 2, "leftTag", "test.tld"),
				new TopicZoomTag( 6, 0, 2, "rightTag", "test.tld" ),
				-1} ;
		// fifth row: weight and significance are equal
		Object[] fivthRow = new Object [] { new TopicZoomTag(2, 0, 1, "leftTag", "test.tld"),
				new TopicZoomTag( 2, 0, 1, "rightTag", "test.tld" ),
				0} ;
		// sixth row: weight is equal, significance of the left higher
		Object[] sixthRow = new Object [] { new TopicZoomTag(6, 0, 1, "leftTag", "test.tld"),
				new TopicZoomTag( 2, 0, 1, "rightTag", "test.tld" ),
				1} ;
		// seventh row: weight of the left is higher, significance lower
		Object[] seventhRow = new Object [] { new TopicZoomTag(2, 0, 2, "leftTag", "test.tld"),
				new TopicZoomTag( 6, 0, 1, "rightTag", "test.tld" ),
				-1} ;
		// eighth row: weight of the left is higher, signifcance is equal
		Object[] eightRow = new Object [] { new TopicZoomTag(6, 0, 2, "leftTag", "test.tld"),
				new TopicZoomTag( 6, 0, 1, "rightTag", "test.tld" ),
				0} ;
		// ninth row: weight and significance are higher
		Object[] ninthRow = new Object [] { new TopicZoomTag(6, 0, 1, "leftTag", "test.tld"),
				new TopicZoomTag( 3, 0, 0, "rightTag", "test.tld" ),
				1} ;		
	...
	public void testCompare() {
		assertEquals( this.expectedValue, this.comparator.compare( this.inputLeftTag, this.inputRightTag ) );
	}
