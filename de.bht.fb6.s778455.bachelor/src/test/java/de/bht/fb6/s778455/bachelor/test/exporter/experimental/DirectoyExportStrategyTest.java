...
/**
 * <p>
 * This class realizes tests of the {@link DirectoryExportStrategy}.
 * </p>
 * 
 * <p>
 * The idea behind this test is to create a sample configuration of models and
 * to export it to the local file system.
 * </p>
 * 
 * <p>
 * The test checks the new folder for correct syntax and structure.
 * </p>
 * 
 * <p>
 * You can configure the testdata folder in the exporter.properties file.
 * </p>
 * 
...
public class DirectoyExportStrategyTest extends NoLoggingTest {
    ...
    @Test
    public void testRemoveIllegalChars() throws NoSuchMethodException,
            SecurityException, IllegalAccessException,
            IllegalArgumentException, InvocationTargetException {
        final Method method = DirectoryExportStrategy.class.getDeclaredMethod(
                "removeIllegalChars", String.class);
        ...
        assertEquals(expected,
                (String) method.invoke(this.exportStrategy, input));
    }
