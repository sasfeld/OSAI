...
import de.bht.fb6.s778455.bachelor.postprocessing.method.EmptyLineFilter;
 ...
 *
 */
public class EmptyLineFilterTest extends NoLoggingTest
{
    ...
    {
        this.method = new EmptyLineFilter();
    }
    ...
    {
        testFilter("Hallo zusammen,\n\nIch mache gerne viele Zeilen.\nSie dienen ja auch der Ästhetik, sind aber schlecht für die NLP und Anonymisierungsverfahren.", 
                "Hallo zusammen,\nIch mache gerne viele Zeilen.\nSie dienen ja auch der Ästhetik, sind aber schlecht für die NLP und Anonymisierungsverfahren."); 
    }
