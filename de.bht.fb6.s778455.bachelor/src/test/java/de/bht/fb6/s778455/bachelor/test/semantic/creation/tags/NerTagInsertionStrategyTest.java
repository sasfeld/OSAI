...
import de.bht.fb6.s778455.bachelor.semantic.creation.tags.NerTagInsertionStrategy;
...
public class NerTagInsertionStrategyTest extends LoggingAwareTest implements
    ...
    private NerTagInsertionStrategy strategy;
    ...
    public void setUp() throws Exception {
        ...
        this.strategy = new NerTagInsertionStrategy( this.adapter );
    ...
    public void testCreateRdfTriples() throws GeneralLoggingException, URISyntaxException {
        ...
        final NerTag nerTag = new NerTag( "I-ORG", 6, "Aktion Mensch", "http://notexisting.tld/unittest" );
        testCourse.addTag( nerTag, TagType.NER_TAG );
        ...
        assertTrue( this.adapter.getPureOntologyModel().contains( 
                ...
                this.adapter.getPureOntologyModel().getResource( nerTag.getRdfUri().toString() ) ));
        
    }
    
    @Test
    public void testAddNodesForNerTags() throws NoSuchMethodException,
        ...
        final Method m = this.strategy.getClass().getDeclaredMethod(
                "addNodesForNerTags", LmsCourseSet.class );
